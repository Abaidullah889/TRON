...
/**
 * The GameBoardWithTwoParallelHurdles class represents a game board with two parallel horizontal hurdles.
 * Players must navigate around these hurdles while avoiding collisions with the boundary, trails, or each other.
 * 
 * This class manages player movement, collision detection, and rendering of the motorcycles,
 * their trails, and the hurdles.
 * 
 * @author 9
 */
public class GameBoardWithTwoParallelHurdles extends JPanel {
    ...
    /**
     * The first horizontal hurdle on the game board.
     */
    private final Rectangle hurdle1 = new Rectangle(100, BOARD_HEIGHT / 2 - 50, 600, 20);

    /**
     * The second horizontal hurdle on the game board.
     */
    private final Rectangle hurdle2 = new Rectangle(100, BOARD_HEIGHT / 2 + 30, 600, 20);

    /**
     * Creates a new game board with two parallel horizontal hurdles.
     * 
     ...
     */
    public GameBoardWithTwoParallelHurdles(String player1Name, String player2Name, Color player1Color, Color player2Color, JLabel timeLabel, GameController controller) {
    ...
    /**
     * Checks for collisions between motorcycles, the hurdles, the boundary, and their trails.
     */
