...
/**
 * The GameBoardWithThreeSmallCircleHurdles class represents a game board with three 
 * small circular hurdles positioned at different locations on the screen. Players 
 * must navigate their motorcycles around these hurdles while competing against each other.
 * 
 ...
 * @author 9
 */
public class GameBoardWithThreeSmallCircleHurdles extends JPanel {
    ...
    /**
     * The radius of the circular hurdles.
     */
    private final int circleRadius = 30;

    /**
     * The position of the first circular hurdle.
     */
    private final int circle1X = 200, circle1Y = 200;

    /**
     * The position of the second circular hurdle.
     */
    private final int circle2X = 400, circle2Y = 300;

    /**
     * The position of the third circular hurdle.
     */
    private final int circle3X = 600, circle3Y = 400;

    /**
     * Constructs a new game board with three small circular hurdles.
     * 
     ...
     */
    public GameBoardWithThreeSmallCircleHurdles(String player1Name, String player2Name, Color player1Color, Color player2Color, JLabel timeLabel, GameController controller) {
        this.timeLabel = timeLabel;
        this.controller = controller;
        motorcycles = new ArrayList<>();
        motorcycles.add(new Motorcycle(100, 200, "RIGHT", player1Color, player1Name));
        motorcycles.add(new Motorcycle(500, 100, "LEFT", player2Color, player2Name));
    ...
    private void checkCollisions() {
        ...
        // Check collision with circular hurdles
        for (Motorcycle motorcycle : motorcycles) {
            int mx = motorcycle.getX();
            int my = motorcycle.getY();

            if (isCollidingWithCircle(mx, my, circle1X, circle1Y) ||
                isCollidingWithCircle(mx, my, circle2X, circle2Y) ||
                isCollidingWithCircle(mx, my, circle3X, circle3Y)) {
                gameTimer.stop();
                Motorcycle winner = (motorcycle == p1) ? p2 : p1;
    ...
    /**
     * Determines if a point is colliding with a circle.
     * 
     ...
     */
    private boolean isCollidingWithCircle(int px, int py, int cx, int cy) {
        int dx = px - cx;
        int dy = py - cy;
    ...
    /**
     * Paints the game board, including the motorcycles, their trails, and the circular hurdles.
     * 
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.fillOval(circle1X - circleRadius, circle1Y - circleRadius, circleRadius * 2, circleRadius * 2);
        g.fillOval(circle2X - circleRadius, circle2Y - circleRadius, circleRadius * 2, circleRadius * 2);
        g.fillOval(circle3X - circleRadius, circle3Y - circleRadius, circleRadius * 2, circleRadius * 2);
