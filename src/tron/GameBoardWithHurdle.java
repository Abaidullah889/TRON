...
/**
 * The GameBoardWithHurdle class represents a game board for the TRON Light-Cycle Battle 
 * game that includes a single rectangular hurdle placed in the center of the screen. 
 * Players must navigate their motorcycles around the hurdle to avoid collisions.
 * 
 * This class manages the movement of motorcycles, collision detection, and rendering 
 * of the game board, hurdle, motorcycles, and their trails.
 * 
 * @author 9
 */
public class GameBoardWithHurdle extends JPanel {
    ...
    /**
     * A rectangular hurdle placed in the center of the game board.
     */
    private final Rectangle hurdle = new Rectangle(BOARD_WIDTH / 2 - 50, BOARD_HEIGHT / 2 - 50, 100, 100);

    /**
     * Constructs a new game board with a single central hurdle.
     * 
     ...
     */
    public GameBoardWithHurdle(String player1Name, String player2Name, Color player1Color, Color player2Color, JLabel timeLabel, GameController controller) {
    ...
    /**
     * Checks for collisions between motorcycles, the hurdle, the boundary, and their trails.
     */
    private void checkCollisions() {
        ...
        // Check collision with the hurdle
        for (Motorcycle motorcycle : motorcycles) {
            if (hurdle.contains(motorcycle.getX(), motorcycle.getY())) {
                gameTimer.stop();
                Motorcycle winner = (motorcycle == p1) ? p2 : p1;
    ...
    /**
     * Paints the game board, including the hurdle, motorcycles, and their trails.
     * 
