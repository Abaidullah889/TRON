...
/**
 * The {@code GameBoardWithCentralCrossHurdle} class represents a game board for the TRON Light-Cycle Battle game
 * that features a central cross-shaped hurdle. Players must navigate their motorcycles while avoiding collisions
 * with the cross-shaped hurdle, boundaries, and other players' trails.
 * 
 ...
 * @author 9
 */
public class GameBoardWithCentralCrossHurdle extends JPanel {
    ...
    /**
     * The horizontal part of the central cross hurdle.
     */
    private final Rectangle horizontalHurdle = new Rectangle(BOARD_WIDTH / 2 - 150, BOARD_HEIGHT / 2 - 25, 300, 50);

    /**
     * The vertical part of the central cross hurdle.
     */
    private final Rectangle verticalHurdle = new Rectangle(BOARD_WIDTH / 2 - 25, BOARD_HEIGHT / 2 - 150, 50, 300);

    /**
     * Constructs a new game board with a central cross hurdle.
     * 
     ...
     */
    public GameBoardWithCentralCrossHurdle(String player1Name, String player2Name, Color player1Color, Color player2Color, JLabel timeLabel, GameController controller) {
    ...
    private void checkCollisions() {
        ...
        // Check collision with the cross hurdles
        for (Motorcycle motorcycle : motorcycles) {
            if (horizontalHurdle.contains(motorcycle.getX(), motorcycle.getY()) ||
                verticalHurdle.contains(motorcycle.getX(), motorcycle.getY())) {
                gameTimer.stop();
                Motorcycle winner = (motorcycle == p1) ? p2 : p1;
    ...
    /**
     * Paints the game board, including the cross hurdles, motorcycles, and their trails.
     * 
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Draw the cross-shaped hurdles
        g.setColor(Color.GRAY);
        g.fillRect(horizontalHurdle.x, horizontalHurdle.y, horizontalHurdle.width, horizontalHurdle.height);
        g.fillRect(verticalHurdle.x, verticalHurdle.y, verticalHurdle.width, verticalHurdle.height);

        // Draw the motorcycles and their trails
        for (Motorcycle motorcycle : motorcycles) {
